...
(function() {
    ...
    var Tb = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/,
        ...
        na = function(a) {
            ...
            return {
                ...
                brighten: function(a) {
                    if (d) m(d, function(b) { b.brighten(a) });
                    else if (qa(a) && a !== 0) { var c; for (c = 0; c < 3; c++) b[c] += B(a * 255), b[c] < 0 && (b[c] = 0), b[c] > 255 && (b[c] = 255) }
                    return this
                },
                rgba: b,
    ...
    ta.prototype = {
        ...
        rect: function(a, b, c, d, e, f) {
            ...
            if (e) a.r = e;
            g.rSetter = function(a) { L(this.element, { rx: a, ry: a }) };
            return g.attr(a)
        },
    ...
    if (!ba && !ea) {
        D = {
            ...
            clip: function(a) {
                var b = this,
                    c;
                a ? (c = a.members, ia(c, b), c.push(b), b.destroyClip = function() { ia(c, b) }, a = a.getCSS(b)) : (b.destroyClip && b.destroyClip(), a = { clip: hb ? "inherit" : "rect(auto)" });
                return b.css(a)
            },
    ...
    va.prototype = {
        ...
        getSeriesExtremes: function() {
            ...
            m(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    a.isLog && d <= 0 && (d = null);
                    if (a.isXAxis) { if (d = c.xData, d.length) a.dataMin = I(p(a.dataMin, d[0]), Pa(d)), a.dataMax = t(p(a.dataMax, d[0]), Fa(d)) } else {
                        c.getExtremes();
                        e = c.dataMax;
                        c = c.dataMin;
        ...
        getPlotLinePath: function(a, b, c, d, e) {
            var f = this.chart,
                ...
                n;
            i = this.transB;
            var o = function(a, b, c) { if (a < b || a > c) d ? a = I(t(b, a), c) : n = !0; return a },
        ...
        destroy: function(a) {
            ...
            m([b.ticks, b.minorTicks, b.alternateBands], function(a) { Qa(a) });
    ...
    Mb.prototype = {
        ...
        hide: function(a) {
            ...
            if (!this.isHidden) c = this.chart.hoverPoints, this.hideTimer = setTimeout(function() {
                b.label.fadeOut();
                b.isHidden = !0
            }, p(a, this.options.hideDelay, 500)), c && m(c, function(a) { a.setState() }), this.chart.hoverPoints = null, this.chart.hoverSeries = null
        },
    ...
    mb.prototype = {
        ...
        getAllItems: function() {
            var a = [];
            m(this.chart.series, function(b) { var c = b.options; if (p(c.showInLegend, !s(c.linkedTo) ? u : !1, !0)) a = a.concat(b.legendItems || (c.legendType === "point" ? b.data : b)) });
            return a
        },
    ...
    D.prototype = {
        ...
        getSelectedPoints: function() {
            var a = [];
            m(this.series, function(b) { a = a.concat(kb(b.points || [], function(a) { return a.selected })) });
            return a
        },
    ...
    Ga.prototype = {
        ...
        optionsToObject: function(a) {
            ...
            if (typeof a === "number" || a === null) b[e[0]] = a;
                ...
                for (; h < f;) b[e[h++]] = a[g++]
            } else if (typeof a === "object") { b = a; if (a.dataLabels) c._hasPointLabels = !0; if (a.marker) c._hasPointMarkers = !0 }
            return b
        },
        destroy: function() {
    ...
    Q.prototype = {
        ...
        buildKDTree: function() {
            ...
            function b() {
                var b = kb(c.points, function(a) { return a.y !== null });
                c.kdTree = a(b, d, d)
            }
            var c = this,
                d = c.kdDimensions;
    ...
    r(D.prototype, {
        ...
        zoom: function(a) {
            var b, c = this.pointer,
                d = !1,
                e;
            !a || a.resetSelection ? m(this.axes, function(a) { b = a.zoom() }) : m(a.xAxis.concat(a.yAxis), function(a) {
                var e = a.axis,
                    h = e.isXAxis;
...
function setViews() {
    if (views.save_views != "OFF" && (lastViewed == 0 || lastViewed != $(".custom_seen").length || lastThumbs != $(".thumb").length)) {
        ...
        $(".thumb").not(".custom_checked").each(function(id, elem) {
